...
/**
 * GoalHub Trainer Home Dashboard
 *
 * Optimized to visually match the supplied 389 x 873 reference.
 *
 * Important:
 ...
 * - Main menu is a compact 2-column grid.
...
const IMG = {
  ...
  doctor: require('@/assets/dashboard/t-doctor.png'),
  stervitje: require('@/assets/dashboard/stervitje.png'),

  /* Main menu */
  lojtaret: require('@/assets/dashboard/lojtaret.png'),
...
const MENU: MenuCard[] = [
...

  {
    ...
    img: IMG.lojtaret,
    imgStyle: styles.menuImgLojtaret,
  },
...

  {
    ...
    img: IMG.mjeksia,
    imgStyle: styles.menuImgMjeksia,
  },
];